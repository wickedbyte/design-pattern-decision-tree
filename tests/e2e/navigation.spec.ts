...
test.describe("Navigation", () => {
  ...
  test("header links navigate correctly", async ({ page }) => {
    ...
    // Navigate Home
    await page.getByRole("link", { name: "Pattern Tree" }).click();
  ...
  test("pattern catalog shows all categories", async ({ page }) => {
    ...
    await expect(page.getByRole("heading", { name: /Creational/ })).toBeVisible();
  ...
  test("pattern card links to detail page", async ({ page }) => {
    ...
    await page.getByRole("link", { name: /Singleton/ }).click();
  ...
  test("pattern detail has breadcrumbs", async ({ page }) => {
    ...
    await expect(breadcrumb.getByText("Patterns")).toBeVisible();
  });
